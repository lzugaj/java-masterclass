...
public class NumberToWords {
    ...
    private static void numberToWords(int number) {
        if (number >= 0) {
            ...
            int differenceInDigitsCount = originalNumberDigitsCount - reversedNumberDigitsCount;
            ...
            while (reversedNumber > 0) {
                ...
                switch (lastDigit) {
                    case 0:
                        numberInWords.append("Zero").append(" ");
                        break;
                    case 1:
                        numberInWords.append("One").append(" ");
                        break;
                    case 2:
                        numberInWords.append("Two").append(" ");
                        break;
                    case 3:
                        numberInWords.append("Three").append(" ");
                        break;
                    case 4:
                        numberInWords.append("Four").append(" ");
                        break;
                    case 5:
                        numberInWords.append("Five").append(" ");
                        break;
                    case 6:
                        numberInWords.append("Six").append(" ");
                        break;
                    case 7:
                        numberInWords.append("Seven").append(" ");
                        break;
                    case 8:
                        numberInWords.append("Eight").append(" ");
                        break;
                    case 9:
                        numberInWords.append("Nine").append(" ");
                        break;
                }
            ...
            for (int i = 0; i < differenceInDigitsCount; i++) {
                numberInWords.append("Zero").append(" ");
            }

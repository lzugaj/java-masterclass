...
public class GreatestCommonDivisor {
    ...
    private static int getGreatestCommonDivisor(int firstNumber, int secondNumber) {
        if (isBetweenRange(firstNumber) && isBetweenRange(secondNumber)) {
            int limitConditionNumber = getLimitConditionNumber(firstNumber, secondNumber);
            int greatestCommonDivisorNumber = 0;
            for (int i = 1; i <= limitConditionNumber; i++) {
    ...
    private static int getLimitConditionNumber(int firstNumber, int secondNumber) {
